...
@Component({
  selector: 'app-nivel-cinco-2',
  templateUrl: './nivel-cinco.2.page.html',
  styleUrls: ['./nivel-cinco.2.page.scss'],
})
export class NivelCinco2Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-cinco.3']);
