...
@Component({
  selector: 'app-nivel-cinco-3',
  templateUrl: './nivel-cinco.3.page.html',
  styleUrls: ['./nivel-cinco.3.page.scss'],
})
export class NivelCinco3Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-cinco.4']);
