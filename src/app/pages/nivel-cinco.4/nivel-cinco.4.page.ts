...
@Component({
  selector: 'app-nivel-cinco-4',
  templateUrl: './nivel-cinco.4.page.html',
  styleUrls: ['./nivel-cinco.4.page.scss'],
})
export class NivelCinco4Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-cinco.5']);
