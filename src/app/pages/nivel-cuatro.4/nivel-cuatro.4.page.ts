...
@Component({
  selector: 'app-nivel-cuatro-4',
  templateUrl: './nivel-cuatro.4.page.html',
  styleUrls: ['./nivel-cuatro.4.page.scss'],
})
export class NivelCuatro4Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'pajaro'; // Respuesta correcta para este nivel
