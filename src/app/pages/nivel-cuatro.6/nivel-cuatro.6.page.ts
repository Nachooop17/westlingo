...
@Component({
  selector: 'app-nivel-cuatro-6',
  templateUrl: './nivel-cuatro.6.page.html',
  styleUrls: ['./nivel-cuatro.6.page.scss'],
})
export class NivelCuatro6Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'conejo'; // Respuesta correcta para este nivel
