...
@Component({
  selector: 'app-nivel-cuatro-7',
  templateUrl: './nivel-cuatro.7.page.html',
  styleUrls: ['./nivel-cuatro.7.page.scss'],
})
export class NivelCuatro7Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'elefante'; // Respuesta correcta para este nivel
