...
@Component({
  selector: 'app-nivel-dos-4',
  templateUrl: './nivel-dos.4.page.html',
  styleUrls: ['./nivel-dos.4.page.scss'],
})
export class NivelDos4Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-dos.5']); // Cambia a nivel 5
