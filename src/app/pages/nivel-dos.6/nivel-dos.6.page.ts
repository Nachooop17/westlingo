...
@Component({
  selector: 'app-nivel-dos-6',
  templateUrl: './nivel-dos.6.page.html',
  styleUrls: ['./nivel-dos.6.page.scss'],
})
export class NivelDos6Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Grupo".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-dos.7']); // Cambia a nivel 7
