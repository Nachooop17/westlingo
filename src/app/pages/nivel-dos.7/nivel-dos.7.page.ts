...
@Component({
  selector: 'app-nivel-dos-7',
  templateUrl: './nivel-dos.7.page.html',
  styleUrls: ['./nivel-dos.7.page.scss'],
})
export class NivelDos7Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Hotel".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-dos.8']); // Cambia a nivel 8
