...
@Component({
  selector: 'app-nivel-nueve-1',
  templateUrl: './nivel-nueve.1.page.html',
  styleUrls: ['./nivel-nueve.1.page.scss'],
})
export class NivelNueve1Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-nueve.2']);
