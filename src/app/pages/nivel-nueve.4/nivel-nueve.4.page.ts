...
@Component({
  selector: 'app-nivel-nueve-4',
  templateUrl: './nivel-nueve.4.page.html',
  styleUrls: ['./nivel-nueve.4.page.scss'],
})
export class NivelNueve4Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-nueve.5']);
