...
@Component({
  selector: 'app-nivel-nueve-5',
  templateUrl: './nivel-nueve.5.page.html',
  styleUrls: ['./nivel-nueve.5.page.scss'],
})
export class NivelNueve5Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-nueve.6']);
