...
@Component({
  selector: 'app-nivel-nueve-7',
  templateUrl: './nivel-nueve.7.page.html',
  styleUrls: ['./nivel-nueve.7.page.scss'],
})
export class NivelNueve7Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Espejo".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-nueve.8']); // Cambia a nivel 8
