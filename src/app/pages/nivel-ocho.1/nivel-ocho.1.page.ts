...
@Component({
  selector: 'app-nivel-ocho-1',
  templateUrl: './nivel-ocho.1.page.html',
  styleUrls: ['./nivel-ocho.1.page.scss'],
})
export class NivelOcho1Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-ocho.2']);
