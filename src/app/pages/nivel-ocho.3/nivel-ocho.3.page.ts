...
@Component({
  selector: 'app-nivel-ocho-3',
  templateUrl: './nivel-ocho.3.page.html',
  styleUrls: ['./nivel-ocho.3.page.scss'],
})
export class NivelOcho3Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    ...
    this.router.navigate(['/nivel-ocho.4']);
