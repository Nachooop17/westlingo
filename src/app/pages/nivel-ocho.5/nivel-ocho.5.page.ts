...
@Component({
  selector: 'app-nivel-ocho-5',
  templateUrl: './nivel-ocho.5.page.html',
  styleUrls: ['./nivel-ocho.5.page.scss'],
})
export class NivelOcho5Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-ocho.6']);
