...
@Component({
  selector: 'app-nivel-ocho-6',
  templateUrl: './nivel-ocho.6.page.html',
  styleUrls: ['./nivel-ocho.6.page.scss'],
})
export class NivelOcho6Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-ocho.7']);
