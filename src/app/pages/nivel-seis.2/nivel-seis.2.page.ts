...
@Component({
  selector: 'app-nivel-seis-2',
  templateUrl: './nivel-seis.2.page.html',
  styleUrls: ['./nivel-seis.2.page.scss'],
})
export class NivelSeis2Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-seis.3']); // Cambia a nivel 6.3
