...
@Component({
  selector: 'app-nivel-seis-4',
  templateUrl: './nivel-seis.4.page.html',
  styleUrls: ['./nivel-seis.4.page.scss'],
})
export class NivelSeis4Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Nunca".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-seis.5']); // Cambia a nivel 6.5
