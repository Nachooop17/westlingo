...
@Component({
  selector: 'app-nivel-seis-5',
  templateUrl: './nivel-seis.5.page.html',
  styleUrls: ['./nivel-seis.5.page.scss'],
})
export class NivelSeis5Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Siempre".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-seis.6']); // Cambia a nivel 6.6
