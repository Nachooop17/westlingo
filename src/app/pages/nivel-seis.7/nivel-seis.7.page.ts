...
@Component({
  selector: 'app-nivel-seis-7',
  templateUrl: './nivel-seis.7.page.html',
  styleUrls: ['./nivel-seis.7.page.scss'],
})
export class NivelSeis7Page {
  public progress = 0;
  ...
  async handleCorrectAnswer() {
    const alert = await this.alertController.create({
      header: '¡Correcto!',
      message: 'La respuesta es correcta, significa "Rara vez".',
      buttons: [{
        text: 'Continuar',
        handler: () => {
          this.correctAnswers++;
          ...
          this.router.navigate(['/nivel-seis.8']); // Cambia a nivel 6.8
