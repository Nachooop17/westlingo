...
@Component({
  selector: 'app-nivel-siete-2',
  templateUrl: './nivel-siete.2.page.html',
  styleUrls: ['./nivel-siete.2.page.scss'],
})
export class NivelSiete2Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'adiós'; // Cambia esto a la respuesta correcta
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-siete.3']); // Cambia a nivel 3
