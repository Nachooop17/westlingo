...
@Component({
  selector: 'app-nivel-siete-3',
  templateUrl: './nivel-siete.3.page.html',
  styleUrls: ['./nivel-siete.3.page.scss'],
})
export class NivelSiete3Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'gracias'; // Cambia esto a la respuesta correcta
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-siete.4']); // Cambia a nivel 4
