...
@Component({
  selector: 'app-nivel-siete-5',
  templateUrl: './nivel-siete.5.page.html',
  styleUrls: ['./nivel-siete.5.page.scss'],
})
export class NivelSiete5Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'disculpa'; // Cambia esto a la respuesta correcta
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-siete.6']); // Cambia a nivel 6
