...
@Component({
  selector: 'app-nivel-siete-7',
  templateUrl: './nivel-siete.7.page.html',
  styleUrls: ['./nivel-siete.7.page.scss'],
})
export class NivelSiete7Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'buenos días'; // Cambia esto a la respuesta correcta
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-siete.8']); // Cambia a nivel 8
