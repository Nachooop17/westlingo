...
@Component({
  selector: 'app-nivel-siete-8',
  templateUrl: './nivel-siete.8.page.html',
  styleUrls: ['./nivel-siete.8.page.scss'],
})
export class NivelSiete8Page {
  public progress = 0;
  ...
  async checkAnswer() {
    const correctAnswer = 'buenas noches'; // Cambia esto a la respuesta correcta
