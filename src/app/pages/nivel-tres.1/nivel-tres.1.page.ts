...
@Component({
  selector: 'app-nivel-tres-1',
  templateUrl: './nivel-tres.1.page.html',
  styleUrls: ['./nivel-tres.1.page.scss'],
})
export class NivelTres1Page {
  public progress = 0;
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-tres.2']);
        }
      }]
    });
    await alert.present();
