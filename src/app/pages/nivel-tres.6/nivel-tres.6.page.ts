...
@Component({
  selector: 'app-nivel-tres-6',
  templateUrl: './nivel-tres.6.page.html',
  styleUrls: ['./nivel-tres.6.page.scss'],
})
export class NivelTres6Page {
  public progress = 0;
  ...
  async verificarRespuesta(respuesta: string) {
    ...
    if (respuesta === respuestaCorrecta) {
      this.resultadoMensaje = '¡Correcto! Has disculpado correctamente.';
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-tres.7']);
        }
      }]
    });
    await alert.present();
