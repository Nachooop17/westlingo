...
@Component({
  selector: 'app-nivel-tres-7',
  templateUrl: './nivel-tres.7.page.html',
  styleUrls: ['./nivel-tres.7.page.scss'],
})
export class NivelTres7Page {
  public progress = 0;
  ...
  async verificarRespuesta(respuesta: string) {
    ...
    if (respuesta === respuestaCorrecta) {
      this.resultadoMensaje = '¡Correcto! Has comentado correctamente.';
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [{
        ...
        handler: () => {
          ...
          this.router.navigate(['/nivel-tres.8']);
        }
      }]
    });
    await alert.present();
